...
func TestResolveReferences(t *testing.T) {
	tests := map[string]func() (*specs.Manifest, *specs.Property, *specs.Property){
		"flow": func() (*specs.Manifest, *specs.Property, *specs.Property) {
		...
		"proxy": func() (*specs.Manifest, *specs.Property, *specs.Property) {
			expected := &specs.Property{
				Reference: &specs.PropertyReference{
					Resource: "expected",
					Path:     "expected",

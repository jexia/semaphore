...
func ResolveNode(manager specs.FlowsInterface, node *specs.Node, unresolved map[string]*specs.Node) error {
...
func FindNode(manager specs.FlowsInterface, node string) *specs.Node {
